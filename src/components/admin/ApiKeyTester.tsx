...
export default function ApiKeyTester({ service, onRefresh }: ApiKeyTesterProps) {
  ...
  // Define supported services for testing
  const supportedServices = ['perplexity', 'openai', 'fred'];
    ...
    <Card className="mb-4">
      <CardHeader className="pb-3">
        <CardTitle className="text-base flex items-center">
          ...
          Test {serviceName} API Connection
        </CardTitle>
      </CardHeader>
      <CardContent>
        {testResult && (
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Test the connection to the {serviceName} API using the stored key
            </p>
          </div>
